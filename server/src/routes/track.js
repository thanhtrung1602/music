...
router.get("/countListen/:id", trackController.countListen);

router.post("/trackListen/", trackController.listen);
...
router.get("/getAllTrackLike/:id", trackController.getAllTrackLike);
